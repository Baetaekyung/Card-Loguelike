...
namespace CardGame.Players
{
    public class Player : MonoBehaviour
    {
        ...
        private PlayerMovement playerMovement => GetPlayerComponent<PlayerMovement>();
        private PlayerRenderer playerRenderer => GetPlayerComponent<PlayerRenderer>();
        ...
        private void HandleOnRoll()
        {
            ...
            if (isPressingAnyDirectionKey)
                playerMovement.AddForce(GetInput.GetCameraRelativeInput, 4);
        ...
        private void Update()
        {
            void PlayerComponentUpdate()
            {
                void PlayerMovement()
                {
                    ...
                    {
                        GetPlayerComponent<PlayerMovement>().AddForce(Vector3.left, 2);
                    }
                }
                void PlayerCamera()
                {
