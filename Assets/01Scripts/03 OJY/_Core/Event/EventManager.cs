...
namespace CardGame.MyEvents
{
    ...
    //{
    //    static readonly Dictionary<Type, Action<BaseEvent>> s_Events = new();

    //    static readonly Dictionary<Delegate, Action<BaseEvent>> s_EventLookups = new();

    //    public static void AddListener<T>(Action<T> evt) where T : BaseEvent
    //    {
    //        if (!s_EventLookups.ContainsKey(evt))
    //        {
    //            void newAction(BaseEvent e) => evt(e as T);
    ...
    //    public static void Broadcast(BaseEvent evt)
    //    {
